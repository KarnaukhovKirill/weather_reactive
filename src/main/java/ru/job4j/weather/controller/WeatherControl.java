...
public class WeatherControl {
    ...
    public Flux<String> getCityGreaterThenTemperature(@PathVariable Integer temperature) {
        Flux<String> data = weathers.findWeatherGreaterByTemp(temperature).map(Weather::getCity);
        return data.map(i -> i + System.lineSeparator());
    }
}
